...
CREATE TABLE IF NOT EXISTS customers(
	...
	CONSTRAINT ck_customers_gender_is_male_or_female
		CHECK (gender = 'M' OR gender = 'F'),
	CONSTRAINT ck_customers_age_is_positive
		CHECK (age > 0),
...
CREATE TABLE IF NOT EXISTS products(
	...
	CONSTRAINT ck_products_price_is_positive
		CHECK (price > 0)
);
...
CREATE TABLE IF NOT EXISTS feedbacks(
	...
	CONSTRAINT ck_feedbacks_rate_is_between_0_and_10
...
CREATE TABLE IF NOT EXISTS products_ingredients(
	...
	CONSTRAINT fk_product_ingredients_products
		FOREIGN KEY (product_id)
		REFERENCES products(id)
		ON UPDATE CASCADE
		ON DELETE CASCADE,
	CONSTRAINT fk_product_ingredients_ingredients
